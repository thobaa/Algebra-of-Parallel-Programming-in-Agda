...
module Value (c : Level) (ℓ : Level)
   (Val-decTotalOrder : DecTotalOrder c ℓ ℓ) 
    where
  Val-decSetoid : DecSetoid c ℓ
  Val-decSetoid = DecTotalOrder.Eq.decSetoid Val-decTotalOrder

  Val-setoid : Setoid c ℓ
...
Val-decTotalOrder : DecTotalOrder _ _ _
Val-decTotalOrder = decTotalOrder

open Value _ _ Val-decTotalOrder public
