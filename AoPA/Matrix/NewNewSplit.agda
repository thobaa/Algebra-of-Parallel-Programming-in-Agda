...
data SplitVec : Splitting -> Set where
  ...
  two : ∀ {s1 s2} -> SplitVec s1 -> SplitVec s2 -> SplitVec (deeper s1 s2)
...
data SplitMat : Splitting -> Splitting -> Set where
  ...
  quad : ∀{r1 r2 c1 c2} -> SplitMat r1 c1 -> SplitMat r1 c2 -> 
                           SplitMat r2 c1 -> SplitMat r2 c2 -> 
                           SplitMat (deeper r1 r2) (deeper c1 c2)
