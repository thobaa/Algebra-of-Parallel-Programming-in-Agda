-- own
open import Matrix.MatrixAlgebra.Definitions using (_≰_; _>_; _<_)
open import Matrix.MatrixAlgebra.NatLemmas   using (m≤sm; m≤m; p≤p)
...
open ℕ.≤-Reasoning renaming (begin_ to nstart_ ; _∎ to _n□; _≡⟨_⟩_ to _n≡'⟨_⟩_; 
                            _≤⟨_⟩_ to _n≤⟨_⟩_ )
module Matrix.MatrixAlgebra.ZLemmas where
