...
\todo{Done (PJ): is it possible to make underscores less ugly?}
\todo{Chase down the last few underscores.}

\subsubsection{Properties of an operation}\todo{THOMAS: Should we give these things names, or use them anyway? (i.e., |OP2| vs |A \to A \to A|}
...
\subsubsection{Properties of a pair of operations}
...
%% GROUPS
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Sets with one binary operation} % alternate title: genralizations
