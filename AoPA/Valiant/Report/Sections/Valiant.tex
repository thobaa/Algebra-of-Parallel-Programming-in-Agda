...
\begin{figure}
  ...
  \begin{subfigure}[b]{0.4\textwidth}
    \centering
    \begin{tikzpicture}
      \matrix[matrix of math nodes,left delimiter = (,right delimiter = ),row sep=5pt,column sep = 5pt,nodes={inner sep=0pt,anchor = center, minimum width=7mm, minimum height = 7mm}, left of = a-1-4] (m) {
        \tc{U_U} & \rc{U_R} & A   & B   \\
        & \tc{U_L} & \rc{C}   & D   \\
        &     & \tc{L_U} & \rc{L_R} \\
        &     &     & \tc{L_L} \\
      ...
      \draw (m-1-2.center) circle (3.5*1.4142mm);
...
\end{tikzpicture}
  ...
  \begin{subfigure}[b]{0.4\textwidth}
    \centering
\begin{tikzpicture}
\matrix[matrix of math nodes,left delimiter = (,right delimiter = ),row sep=5pt,column sep = 5pt,nodes={inner sep=0pt,anchor = center, minimum width=7mm, minimum height = 7mm}, below of = m] (n) {
\tc{U_U} & \rc{U_R} & \rc{A}   & B   \\
    & \tc{U_L} & \rc{C}   & \rc{D}   \\
    &     & \tc{L_U} & \rc{L_R} \\
    &     &     & \tc{L_L} \\
...
\draw [->] (n-1-2.south east) -- (n-2-4.north west);
\draw [->] (n-1-3.south east) -- (n-3-4.north west);
