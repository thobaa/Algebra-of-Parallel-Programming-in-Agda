...
The full formalization and proof is made up of around 3500 lines of code, partitioned into around 30 modules, all of which is available at [URL]\todo{THOMAS: include URL at later stage}.
...
Additionally, working in Agda allows us to write an algorithm and prove its correctness simultaneously. %In particular, Agda has helped us choose the right definitions in a couple of cases when they have been they have turned out to be the only ones with the right type.
