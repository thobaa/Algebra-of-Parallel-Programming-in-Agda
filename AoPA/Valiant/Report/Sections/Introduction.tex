...
% functional program
Parsing is used in a large number of areas, including as an eaerly step during compilation, bioinformatics and computational linguistics. \todo{either cite or expand}
