...
\end{code}
In the remainder of the report, we actually use the slightly more general |IsEquivalence| definition in the Agda Standard Library, because it lets us use the |EqReasoning| module from the Standard Library modules for equational reasoning, as examplified in Section \ref{Section-where-eqr-helper-is-defined}.
