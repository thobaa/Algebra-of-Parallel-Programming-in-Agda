\chapter{Agda}
\label{Agda}
Agda is a dependently typed functional language based on Martin-Löf type theory \cite{Martin-Löf}. The implementation of the current version of Agda, Agda 2, was started by Ulf Norell as a part of his PhD \citep{NorellAgda}.
