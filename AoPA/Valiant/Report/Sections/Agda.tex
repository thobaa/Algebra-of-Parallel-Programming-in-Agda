...
\todo{THOMAS: Emacs mode?}
% emacs mode ???
%To help with programming, there is an Emacs interface for Agda that allows type checking of 
...
\todo{Notes by JP:
  1. Every binding can be given a name. (important?)
  %2. Explain |_|.
  %3. Use of spacing.
  %4. Totality.
}
