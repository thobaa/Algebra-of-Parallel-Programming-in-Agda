...
open Valiant.Concrete.Mat.Properties NAR renaming (commutativeMonoid to m-cm; v-commutativeMonoid to v-cm)
...
*|-distribˡ (quad A B C D) (two u v) (two u' v') = two-eq 
    (rearrangeLemma' {cm = v-cm} (A *| (u ⊕ u')) (B *| (v ⊕ v')) (A *| u) (A *| u') (B *| v) (B *| v') (*|-distribˡ A u u') (*|-distribˡ B v v')) 
    (rearrangeLemma' {cm = v-cm} (C *| (u ⊕ u')) (D *| (v ⊕ v')) (C *| u) (C *| u') (D *| v) (D *| v') (*|-distribˡ C u u') (*|-distribˡ D v v')) 
...
*|-distribʳ (quad A B C D) (quad A' B' C' D') (two u v) = two-eq (rearrangeLemma' {cm = v-cm} ((A + A') *| u) ((B + B') *| v) (A *| u) (A' *| u) (B *| v) (B' *| v) (*|-distribʳ A A' u) (*|-distribʳ B B' v)) (rearrangeLemma' {cm = v-cm} ((C + C') *| u) ((D + D') *| v) (C *| u) (C' *| u) (D *| v) (D' *| v)(*|-distribʳ C C' u) (*|-distribʳ D D' v))
...
|*-distribˡ (two u v) (quad A B C D) (quad A' B' C' D') = two-eq (rearrangeLemma' {cm = v-cm} (u |* (A + A')) (v |* (C + C')) (u |* A) (u |* A') (v |* C) (v |* C') (|*-distribˡ u A A') (|*-distribˡ v C C')) (rearrangeLemma' {cm = v-cm} (u |* (B + B')) (v |* (D + D')) (u |* B) (u |* B') (v |* D) (v |* D') (|*-distribˡ u B B') (|*-distribˡ v D D'))
...
|*-distribʳ (two u v) (two u' v') (quad A B C D) = two-eq (rearrangeLemma' {cm = v-cm} ((u ⊕ u') |* A) ((v ⊕ v') |* C) (u |* A) (u' |* A) (v |* C) (v' |* C) (|*-distribʳ u u' A) (|*-distribʳ v v' C)) (rearrangeLemma' {cm = v-cm} ((u ⊕ u') |* B) ((v ⊕ v') |* D) (u |* B) (u' |* B) (v |* D) (v' |* D) (|*-distribʳ u u' B) (|*-distribʳ v v' D))
...
*-distribˡ (RVec (two u v)) (quad A B C D) (quad A' B' C' D') = RVec-eq (two-eq (rearrangeLemma' {cm = v-cm} (u |* (A + A')) (v |* (C + C')) (u |* A) (u |* A') (v |* C) (v |* C') (|*-distribˡ u A A') (|*-distribˡ v C C')) (rearrangeLemma' {cm = v-cm} (u |* (B + B')) (v |* (D + D')) (u |* B) (u |* B') (v |* D) (v |* D') (|*-distribˡ u B B') (|*-distribˡ v D D')))
...
*-distribˡ (quad A B C D) (CVec (two u v)) (CVec (two u' v')) = CVec-eq (two-eq (rearrangeLemma' {cm = v-cm} (A *| (u ⊕ u')) (B *| (v ⊕ v')) (A *| u) (A *| u') (B *| v) (B *| v') (*|-distribˡ A u u') (*|-distribˡ B v v')) (rearrangeLemma' {cm = v-cm} (C *| (u ⊕ u')) (D *| (v ⊕ v')) (C *| u) (C *| u') (D *| v) (D *| v') (*|-distribˡ C u u') (*|-distribˡ D v v')))
*-distribˡ (quad A₁ B₁ C₁ D₁) (quad A₂ B₂ C₂ D₂) (quad A₃ B₃ C₃ D₃) = quad-eq (rearrangeLemma' {cm = m-cm} (A₁ * (A₂ + A₃)) (B₁ * (C₂ + C₃)) (A₁ * A₂) (A₁ * A₃) (B₁ * C₂) (B₁ * C₃) (*-distribˡ A₁ A₂ A₃) (*-distribˡ B₁ C₂ C₃)) (rearrangeLemma' {cm = m-cm} (A₁ * (B₂ + B₃)) (B₁ * (D₂ + D₃)) (A₁ * B₂) (A₁ * B₃) (B₁ * D₂) (B₁ * D₃) (*-distribˡ A₁ B₂ B₃) (*-distribˡ B₁ D₂ D₃)) (rearrangeLemma' {cm = m-cm} (C₁ * (A₂ + A₃)) (D₁ * (C₂ + C₃)) (C₁ * A₂) (C₁ * A₃) (D₁ * C₂) (D₁ * C₃) (*-distribˡ C₁ A₂ A₃) (*-distribˡ D₁ C₂ C₃)) (rearrangeLemma' {cm = m-cm} (C₁ * (B₂ + B₃)) (D₁ * (D₂ + D₃)) (C₁ * B₂) (C₁ * B₃) (D₁ * D₂) (D₁ * D₃) (*-distribˡ C₁ B₂ B₃) (*-distribˡ D₁ D₂ D₃))
...
*-distribʳ (RVec (two u v)) (RVec (two u' v')) (quad A B C D) = RVec-eq (two-eq (rearrangeLemma' {cm = v-cm} ((u ⊕ u') |* A) ((v ⊕ v') |* C) (u |* A) (u' |* A) (v |* C) (v' |* C) (|*-distribʳ u u' A) (|*-distribʳ v v' C)) (rearrangeLemma' {cm = v-cm} ((u ⊕ u') |* B) ((v ⊕ v') |* D) (u |* B) (u' |* B) (v |* D) (v' |* D) (|*-distribʳ u u' B) (|*-distribʳ v v' D)))
...
*-distribʳ (quad A B C D) (quad A' B' C' D') (CVec (two u v)) = CVec-eq (two-eq (rearrangeLemma' {cm = v-cm} ((A + A') *| u) ((B + B') *| v) (A *| u) (A' *| u) (B *| v) (B' *| v) (*|-distribʳ A A' u) (*|-distribʳ B B' v)) (rearrangeLemma' {cm = v-cm} ((C + C') *| u) ((D + D') *| v) (C *| u) (C' *| u) (D *| v) (D' *| v) (*|-distribʳ C C' u) (*|-distribʳ D D' v)))
*-distribʳ (quad A₁ B₁ C₁ D₁) (quad A₂ B₂ C₂ D₂) (quad A₃ B₃ C₃ D₃) = quad-eq (rearrangeLemma' {cm = m-cm} ((A₁ + A₂) * A₃) ((B₁ + B₂) * C₃) (A₁ * A₃) (A₂ * A₃) (B₁ * C₃) (B₂ * C₃) (*-distribʳ A₁ A₂ A₃) (*-distribʳ B₁ B₂ C₃)) (rearrangeLemma' {cm = m-cm} ((A₁ + A₂) * B₃) ((B₁ + B₂) * D₃) (A₁ * B₃) (A₂ * B₃) (B₁ * D₃) (B₂ * D₃) (*-distribʳ A₁ A₂ B₃) (*-distribʳ B₁ B₂ D₃)) (rearrangeLemma' {cm = m-cm} ((C₁ + C₂) * A₃) ((D₁ + D₂) * C₃) (C₁ * A₃) (C₂ * A₃) (D₁ * C₃) (D₂ * C₃) (*-distribʳ C₁ C₂ A₃) (*-distribʳ D₁ D₂ C₃)) (rearrangeLemma' {cm = m-cm} ((C₁ + C₂) * B₃) ((D₁ + D₂) * D₃) (C₁ * B₃) (C₂ * B₃) (D₁ * D₃) (D₂ * D₃) (*-distribʳ C₁ C₂ B₃) (*-distribʳ D₁ D₂ D₃))

◂|-distribˡ : ∀ {s} → (x : Tri s) (u v : Vec s) → x ◂| (u ⊕ v) v≈ x ◂| u ⊕ x ◂| v
◂|-distribˡ one (one x) (one x') = one-eq (≈sym (proj₁ R+-identity R0)) --symV (proj₁ {!R+-identity!})
◂|-distribˡ (two U R L) (two u₁ v₁) (two u₂ v₂) = two-eq (rearrangeLemma' {cm = v-cm} (U ◂| (u₁ ⊕ u₂)) (R *| (v₁ ⊕ v₂)) (U ◂| u₁) (U ◂| u₂) (R *| v₁) (R *| v₂) (◂|-distribˡ U u₁ u₂) (*|-distribˡ R v₁ v₂)) (◂|-distribˡ L v₁ v₂)


◂|-distribʳ : ∀ {s} → (x y : Tri s) (v : Vec s) → (x ◂+ y) ◂| v v≈ x ◂| v ⊕ y ◂| v
◂|-distribʳ one u v = one-eq (≈sym (proj₁ R+-identity R0))
◂|-distribʳ (two U R L) (two U' R' L') (two u v) = two-eq (rearrangeLemma' {cm = v-cm} ((U ◂+ U') ◂| u) ((R + R') *| v) (U ◂| u) (U' ◂| u) (R *| v) (R' *| v) (◂|-distribʳ U U' u) (*|-distribʳ R R' v)) (◂|-distribʳ L L' v)

|◂-distribˡ : ∀ {s} → (v : Vec s) (x y : Tri s) → v |◂ (x ◂+ y) v≈ v |◂ x ⊕ v |◂ y
|◂-distribˡ (one x) u v = one-eq (≈sym (proj₁ R+-identity R0))
|◂-distribˡ (two u v) (two U R L) (two U' R' L') = two-eq (|◂-distribˡ u U U') (rearrangeLemma' {cm = v-cm} (u |* (R + R')) (v |◂ (L ◂+ L')) (u |* R) (u |* R') (v |◂ L) (v |◂ L') (|*-distribˡ u R R') (|◂-distribˡ v L L'))

|◂-distribʳ : ∀ {s} → (u v : Vec s) (x : Tri s) → (u ⊕ v) |◂ x v≈ u |◂ x ⊕ v |◂ x
|◂-distribʳ (one x) (one y) one = one-eq (≈sym (proj₁ R+-identity R0))
|◂-distribʳ (two u v) (two u' v') (two U R L) = two-eq (|◂-distribʳ u u' U) (rearrangeLemma' {cm = v-cm} ((u ⊕ u') |* R) ((v ⊕ v') |◂ L) (u |* R) (u' |* R) (v |◂ L) (v' |◂ L) (|*-distribʳ u u' R) (|◂-distribʳ v v' L))
...
◂*-distribˡ (two U R L) (quad A B C D) (quad A' B' C' D') = quad-eq (rearrangeLemma' {cm = m-cm} (U ◂* (A + A')) (R * (C + C')) (U ◂* A) (U ◂* A') (R * C) (R * C') (◂*-distribˡ U A A') (*-distribˡ R C C')) (rearrangeLemma' {cm = m-cm} (U ◂* (B + B')) (R * (D + D')) (U ◂* B) (U ◂* B') (R * D) (R * D') (◂*-distribˡ U B B') (*-distribˡ R D D')) (◂*-distribˡ L C C') (◂*-distribˡ L D D')
...
◂*-distribʳ (two U R L) (two U' R' L') (CVec (two u v)) = CVec-eq (two-eq (rearrangeLemma' {cm = v-cm} ((U ◂+ U') ◂| u) ((R + R') *| v) (U ◂| u) (U' ◂| u) (R *| v) (R' *| v) (◂|-distribʳ U U' u) (*|-distribʳ R R' v)) (◂|-distribʳ L L' v))
◂*-distribʳ (two U R L) (two U' R' L') (quad A B C D) = quad-eq (rearrangeLemma' {cm = m-cm} ((U ◂+ U') ◂* A) ((R + R') * C) (U ◂* A) (U' ◂* A) (R * C) (R' * C) (◂*-distribʳ U U' A) (*-distribʳ R R' C)) (rearrangeLemma' {cm = m-cm} ((U ◂+ U') ◂* B) ((R + R') * D) (U ◂* B) (U' ◂* B) (R * D) (R' * D) (◂*-distribʳ U U' B) (*-distribʳ R R' D)) (◂*-distribʳ L L' C) (◂*-distribʳ L L' D)
...
*◂-distribˡ (quad A B C D) (two U R L) (two U' R' L') = quad-eq (*◂-distribˡ A U U') (rearrangeLemma' {cm = m-cm} (A * (R + R')) (B *◂ (L ◂+ L')) (A * R) (A * R') (B *◂ L) (B *◂ L') (*-distribˡ A R R') (*◂-distribˡ B L L')) (*◂-distribˡ C U U') (rearrangeLemma' {cm = m-cm} (C * (R + R')) (D *◂ (L ◂+ L')) (C * R) (C * R') (D *◂ L) (D *◂ L') (*-distribˡ C R R') (*◂-distribˡ D L L')) 

*◂-distribʳ : ∀ {s₁ s₂} → (x y : Mat s₁ s₂) (z : Tri s₂) → (x + y) *◂ z m≈ x *◂ z + y *◂ z
*◂-distribʳ (Sing x) (Sing y) one = Sing-eq (≈sym (proj₁ R+-identity R0))
*◂-distribʳ (RVec (two u v)) (RVec (two u' v')) (two U R L) = RVec-eq (two-eq (|◂-distribʳ u u' U) (rearrangeLemma' {cm = v-cm} ((u ⊕ u') |* R) ((v ⊕ v') |◂ L) (u |* R) (u' |* R) (v |◂ L) (v' |◂ L) (|*-distribʳ u u' R) (|◂-distribʳ v v' L)))
*◂-distribʳ (CVec v) (CVec v') one = CVec-eq (two-eq (v-sym (identityˡV zeroVec)) (v-sym (identityˡV zeroVec)))
*◂-distribʳ (quad A B C D) (quad A' B' C' D') (two U R L) = quad-eq (*◂-distribʳ A A' U) (rearrangeLemma' {cm = m-cm} ((A + A') * R) ((B + B') *◂ L) (A * R) (A' * R) (B *◂ L) (B' *◂ L) (*-distribʳ A A' R) (*◂-distribʳ B B' L)) (*◂-distribʳ C C' U) (rearrangeLemma' {cm = m-cm} ((C + C') * R) ((D + D') *◂ L) (C * R) (C' * R) (D *◂ L) (D' *◂ L) (*-distribʳ C C' R) (*◂-distribʳ D D' L))
--*◂-distrib : 
...
◂-distribˡ (two U₁ R₁ L₁) (two U₂ R₂ L₂) (two U₃ R₃ L₃) = two-eq (◂-distribˡ U₁ U₂ U₃) (rearrangeLemma' {cm = m-cm} (U₁ ◂* (R₂ + R₃)) (R₁ *◂ (L₂ ◂+ L₃)) (U₁ ◂* R₂) (U₁ ◂* R₃) (R₁ *◂ L₂) (R₁ *◂ L₃) (◂*-distribˡ U₁ R₂ R₃) (*◂-distribˡ R₁ L₂ L₃)) --(lemma U₁ R₁ R₂ R₃ L₂ L₃) 
                                                                                     (◂-distribˡ L₁ L₂ L₃)

◂-distribʳ : ∀ {s} → (x y z : Tri s) → (y ◂+ z) ◂ x t≈ y ◂ x ◂+ z ◂ x
◂-distribʳ one one one = one-eq
◂-distribʳ (two U₁ R₁ L₁) (two U₂ R₂ L₂) (two U₃ R₃ L₃) = two-eq (◂-distribʳ U₁ U₂ U₃) (rearrangeLemma' {cm = m-cm} ((U₂ ◂+ U₃) ◂* R₁) ((R₂ + R₃) *◂ L₁) (U₂ ◂* R₁) (U₃ ◂* R₁) (R₂ *◂ L₁) (R₃ *◂ L₁) (◂*-distribʳ U₂ U₃ R₁) (*◂-distribʳ R₂ R₃ L₁)) 
                                                                 (◂-distribʳ L₁ L₂ L₃)
